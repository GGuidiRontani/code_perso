...
xcopy "E:\2020_mel_ortho\orthophotos\mel_cog.tif" \\batzella.lmcu.fr\vuesaeriennes\orthos\2020\tiff_cog

rem modele numerique
rem creation liste des tuiles
dir /b /s "\\batzella.lmcu.fr\lidar\2020\vansteelandt\raster\2020_cadastre_solaire\2023_01_livraison_presta\raster\irradiation\valeurs_annuelles\*.tif" > "E:\0_en_cours\2020_cadstre_solaire\tiles_list.txt"
